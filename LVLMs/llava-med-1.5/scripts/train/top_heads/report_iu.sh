...
# bbox_ratios=(0.01 0.05 0.08 0.1)
bbox_ratios=(0.25)
# bbox_ratios=()
...
#     dir=llava_med_1.5/ours_v1_w_KL/top${head_num}_balance_top2/all_expert_1_8_rank16/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
...
#         --data_path ${ROOT_PATH}/hallucination/IU_Xray/data_report/training_masks_top4.json \
#         --segment_path ${ROOT_PATH}/hallucination/IU_Xray/data_report/training_segments_top4.npz \
...
#         --bf16 True \
#         --output_dir ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/checkpoints \
...
#     #     --question-file ${ROOT_PATH}/hallucination/IU_Xray/data_report/test.json \
...
#     #     --top_moe_num 2 \
#     #     --baseline beam \
#     #     --answers-file ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/pred_beam.jsonl \
#     #     --peft-path ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/checkpoints
...
#     #     --top_moe_num 2 \
#     #     --baseline greedy \
#     #     --answers-file ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/pred_greedy.jsonl \
#     #     --peft-path ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/checkpoints
#     # python ${ROOT_PATH}/hallucination/mitigation/report_eval/run_eval.py \
#     #     --gt ${ROOT_PATH}/hallucination/${dataset}/data_report/test.csv \
#     #     --pred ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/pred_beam.csv \
#     #     --eval_res ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/eval_res_beam.csv \
#     #     --report True
#     # python ${ROOT_PATH}/hallucination/mitigation/report_eval/run_eval.py \
#     #     --gt ${ROOT_PATH}/hallucination/${dataset}/data_report/test.csv \
#     #     --pred ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/pred_greedy.csv \
#     #     --eval_res ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/eval_res_greedy.csv \
#     #     --report True
#     # wait

#     # python ${ROOT_PATH}/hallucination/mitigation/report_eval/run_all_metrics.py \
#     #     --model_answers_file ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/pred_beam.jsonl \
#     #     --eval_res_file ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/eval_all_metrics_beam.txt \
#     #     --RadGraphFile ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/eval_res_beam.csv

#     # python ${ROOT_PATH}/hallucination/mitigation/report_eval/run_all_metrics.py \
#     #     --model_answers_file ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/pred_greedy.jsonl \
#     #     --eval_res_file ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/eval_all_metrics_greedy.txt \
#     #     --RadGraphFile ${ROOT_PATH}/hallucination/mitigation/${dataset}_report/${dir}/inference/eval_res_greedy.csv
#     # wait
