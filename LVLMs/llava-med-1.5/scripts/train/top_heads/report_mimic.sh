...
bbox_ratios=(0.02 0.04 0.06 0.08 0.1)
# bbox_ratios=(0.05)
# bbox_ratios=()
...
for bbox_ratio in "${bbox_ratios[@]}"; do
    ...
    dir=llava_med_1.5/ours_v1_wo_KL/top${head_num}_balance_top2/all_expert_1_8_rank16/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
...
for seed in "${seeds[@]}"; do
    ...
    baselines=(PAI m3id avisc VCD DoLa beam greedy nucleus) 
#     # baselines=(VCD) 
