...
for seed in "${seeds[@]}"; do
    echo "Running with head: $seed"
    dir=llava_med_1.5/lora/0.1_data/epoch${epoch_num}_seed${seed}
    ...
    deepspeed llava/train/train_mem.py \
        ...
        --data_path ${ROOT_PATH}/hallucination/${dataset}/data/few_shot/training_masks_1%.json \
