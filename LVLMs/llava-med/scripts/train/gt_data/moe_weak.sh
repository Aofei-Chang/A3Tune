...
for bbox_ratio in "${bbox_ratios[@]}"; do
    ...
    dir=llava_med/gt_exp/weak_bbox/all_expert_8_16_rank16/lora_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
...
bbox_ratios=(0.03 0.05 0.08 0.1 0.15)
epoch_num=9

for bbox_ratio in "${bbox_ratios[@]}"; do
    echo "Running with seed: $seed, bbox_ratio: $bbox_ratio"
    # dir=llava_med/gt_exp/only_gt/all_expert_4_8_rank16/lora_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
    dir=llava_med/gt_exp/only_gt/all_expert_8_16_rank16/lora_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
