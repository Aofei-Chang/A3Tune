...
for seed in "${seeds[@]}"; do
    ...
    dir="llava_med/lora/epoch${num_epochs}/seed${seed}"
    ...
    #     --data_path ${ROOT_PATH}/hallucination/CARES/${dataset}/training.json \
    ...
    # wait
    # baselines=(DoLa PAI opera greedy nucleus VCD)
    # baselines=(VCD m3id avisc)
    baselines=(VCD)
    for baseline in "${baselines[@]}"; do
        python llava/eval/eval_batch.py --num-chunks 1  --model-name ${ROOT_PATH}/LLM/llava_med \
