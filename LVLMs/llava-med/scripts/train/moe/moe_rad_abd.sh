...
dir=llava_med/moe_query/abd/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}
...
torchrun --nnodes=1 --nproc_per_node=4 --master_port=25001 \
    ...
    --data_path ${ROOT_PATH}/hallucination/${dataset}/data/training_bboxes_abd.json \
