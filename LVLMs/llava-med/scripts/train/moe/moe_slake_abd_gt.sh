...
dir=llava_med/moe_img_query_gt/only_abd_top1/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}
...
torchrun --nnodes=1 --nproc_per_node=4 --master_port=25001 \
    ...
    --data_path ${ROOT_PATH}/hallucination/${dataset}/data/training_gt_only_bboxes_abd.json \
