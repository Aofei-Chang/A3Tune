...
for epoch_num in "${epochs[@]}"; do
    echo "Running with seed: $seed, head_num: $head_num, $epoch_num"
    ...
    dir=llava_med/ours_v1/top${head_num}_balance_top2/all_expert_4_8_rank16/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
    ...
    python llava/eval/eval_batch.py --num-chunks 4  --model-name ${ROOT_PATH}/LLM/llava_med \
        --question-file ${ROOT_PATH}/hallucination/CARES/${dataset}/test_w_options.json \
    ...
    python llava/eval/run_eval.py \
        --gt ${ROOT_PATH}/hallucination/CARES/${dataset}/test_w_options.json \
