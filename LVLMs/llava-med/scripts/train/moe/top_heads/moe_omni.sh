...
# Add the commands you want to execute after the sleep period
echo "Woke up after 4 hours and 30 minutes!"
...
for bbox_ratio in 0.03 0.06 0.09 0.12; do
    ...
    dir=llava_med/ours_v1_wo_KL/top${head_num}_balance_top3/all_expert_8_16_rank16/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
