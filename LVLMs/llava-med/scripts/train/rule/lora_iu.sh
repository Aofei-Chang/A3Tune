...
for seed in "${seeds[@]}"; do
    ...
    dir="llava_med/rule_lora/epoch6/seed${seed}"
    ...
    #     --data_path ${ROOT_PATH}/hallucination/RULE/training/alignment/${dataset}/training.json \
    ...
    #     --question-file ${ROOT_PATH}/hallucination/RULE/training/alignment/${dataset}/test.json \
    ...
    python llava/eval/run_eval.py \
        --gt ${ROOT_PATH}/hallucination/RULE/training/alignment/${dataset}/test.json \
