...
bbox_ratio=0.1
epoch_num=6
#abd 04: exper 08, remove q,k lora
dir=llava_med/mixed/abd_01/expert4_8_rank16/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}
...
torchrun --nnodes=1 --nproc_per_node=4 --master_port=25001 \
    ...
    --data_path ${ROOT_PATH}/hallucination/${dataset}/data/training_mixed_abd.json \
