...
for head in "${seeds[@]}"; do
    ...
    dir=llava_med/ours_few_shot/10%_tophead_${head}/all_expert_4_8_rank4/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
    # dir=llava_med/ours_v0/alpha_1r/all_expert_8_16_rank16/lora_${visual_enhance_ratio}_bbox_${bbox_ratio}/epoch${epoch_num}_seed${seed}
...
for seed in "${seeds[@]}"; do
    ...
    dir=llava_med/lora/epoch6_v2/0.1_data/rank8_seed${seed}
    torchrun --nnodes=1 --nproc_per_node=4 --master_port=25001 \
        llava/train/train_mem.py \
        --model_name_or_path ${ROOT_PATH}/LLM/llava_med \
        --lora_enable True \
