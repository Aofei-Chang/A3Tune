...
python llava/eval/eval_batch.py --num-chunks 4  --model-name ${ROOT_PATH}/LLM/llava_med \
    ...
    --answers-file ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/greedy/pred.jsonl \
    --baseline greedy
...
python llava/eval/run_eval.py \
    ...
    --pred ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/greedy/pred.jsonl \
    --eval_res ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/greedy/eval_res.txt