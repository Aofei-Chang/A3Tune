...
python llava/eval/eval_batch.py --num-chunks 4  --model-name ${ROOT_PATH}/LLM/llava_med \
    ...
    --answers-file ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/opera/pred.jsonl \
    --baseline opera \
...
python llava/eval/run_eval.py \
    ...
    --pred ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/opera/pred.jsonl \
    --eval_res ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/opera/eval_res.txt