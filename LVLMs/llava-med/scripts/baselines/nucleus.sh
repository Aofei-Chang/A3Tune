...
python llava/eval/eval_batch.py --num-chunks 4  --model-name ${ROOT_PATH}/LLM/llava_med \
    ...
    --answers-file ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/nucleus/pred.jsonl \
    --baseline nucleus \
...
python llava/eval/run_eval.py \
    ...
    --pred ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/nucleus/pred.jsonl \
    --eval_res ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/nucleus/eval_res.txt