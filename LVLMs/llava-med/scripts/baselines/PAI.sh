...
dir=llava_med/lora/epoch6_v2/seed4
...
python llava/eval/eval_batch.py --num-chunks 4  --model-name ${ROOT_PATH}/LLM/llava_med \
    ...
    --answers-file ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/PAI/pred.jsonl \
    --baseline PAI \
...
python llava/eval/run_eval.py \
    ...
    --pred ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/PAI/pred.jsonl \
    --eval_res ${ROOT_PATH}/hallucination/mitigation/${dataset}/${dir}/baselines/PAI/eval_res.txt