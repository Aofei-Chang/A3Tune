...
class LoRA_MOE_QK(nn.Module): # for Q,K,V,O in attention
    ...
    def forward(self, x):
        ...
        # #     moe_out = self.forward_lora_moe(x, self.original_module, routing, self.moe)
        # # else:
        # moe_out = self.forward_lora_moe_sparse(x, self.original_module, index, self.moe)

        # return moe_out, (routing, expert_choice)
