...
import torch
import sys
sys.path.append("/home/avc6555/research/MedH/Mitigation/LVLM_interp/src/caption")
...
print("Current working directory:", current_dir, sys.path)
...
def run_llava_model_embed(
    ...
    if text_prompt == None:
        ...
        # text_prompt = "Write a detailed description about this medical image."
        text_prompt = "What is this organ in the image?"
    ...
    liver_prompts = torch.load("/home/avc6555/research/MedH/visualize/llava_visualize/data/visual_prompt_liver.pt")
    inputs_embeds[:,35:35+576,:] += liver_prompts
    # Model parameters
...
def retrieve_logit_lens_llava(state, img_path):
    ...
    input_ids, output = run_llava_model_embed(
        state["model"],
        state["model_name"],
        images_tensor,
        image_sizes,
...
def get_caption_from_llava(
    ...
    new_caption = run_llava_model_embed(
        model,
        model_name,
        images_tensor,
        image_sizes,
...
def load_llava_state(device="cuda"):
    ...
    # model_path = "/data/aofei/LLM/llava-v1.5"
